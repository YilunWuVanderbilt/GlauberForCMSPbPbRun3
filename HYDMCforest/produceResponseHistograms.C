...
TH2D * Npix_vs_HF;
 ...
 TFile * infile = TFile::Open("/location/you/store/HYD_official_GT132X_mcRun3_2023_realistic_HI_v9_out_combined.root");  // HYDJET
 ...
 for (int ih = 0; ih < nhist; ih++) {
  ...
  HF_vs_Npart[ih]= new TH2D(Form("HF_vs_Npart_%d",ih),";N_{part};#Sigma HF E_{T}",450,0,450,8000,0,8000);
  Npix_vs_Npart[ih]= new TH2D(Form("Npix_vs_Npart_%d",ih),";N_{part};hiNpix",450,0,450,45000,0,45000);

 }
  Npix_vs_HF = new TH2D(Form("Npix_vs_HF"),";#Sigma HF E_{T};hiNpix",8000,0,8000,4500,0,45000);
 ...
 for(int iev = 0; iev < nEvents; iev++) {
  ...
  TFile * outfile = new TFile("ForSmearingEposLHC_2018Response5020_d20190806_v1.root","recreate");
